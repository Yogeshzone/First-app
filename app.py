...
def main():
    ...
    if page == "Introduction":
        ...
        st.write("This is a Streamlit app created by me, Yogesh landge.")
        ...
        weight = st.slider("Enter your weight", min_value=1, max_value=200)
        # take height of the user in slider
        height = st.slider("Enter your height", min_value=1, max_value=200)
